angular.module('portfolio', [
    ...
    '$scope',
    '$stateParams',
    function($http, $ionicActionSheet, $ionicModal, $q, $rootScope, $scope, $stateParams) {
        function initialize() {
            ...
            $http.get('/user/' + username + '/portfolio/' + portfolio + '/nextToken/' + nextToken).then(
                function(response) {
                    ...
                    if (response.data.items && response.data.items.length > 0) {
                        Array.prototype.push.apply(existingItems, response.data.items);
        ...
        function deleteItemFromPortfolio(/* String */ username, /* Object */ item, /* String */ portfolio, /* int */ index) {
            var hideSheet = $ionicActionSheet.show({
                ...
                destructiveButtonClicked: function(index) {
                    ...
                    $http['delete']('/user/' + username + '/portfolio/' + portfolio + '/item/' + item.itemId).then(
                        ...
                        function(response) {
                            console.log('unable to delete item from portfolio', response);
                        }
                    );
                }
            });
